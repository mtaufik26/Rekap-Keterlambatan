                        ...
                        <form action="{{ route('rayon.update', $rayon->id) }}" method="POST">
                            ...
                            <div class="basic-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-default" placeholder="Rayon..." name="rayon" value="{{ $rayon->rayon }}">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-white" name="user_id">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ $rayon->user_id == $user->id ? 'selected' : '' }}>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>                                   
                            </div>
